...
import {click, expectText, findEls} from '../spec-helpers';
...
@Component({
  ...
  template: `
    <ul>
      <li *appPaginate="let item of items; perPage: 3; controls: controls" data-testid="item">
        {{ item }}
      </li>
    </ul>
    <ng-template #controls
      ...
      <button (click)="previousPage()" data-testid="previousPage">Previous page</button>
      <span data-testid="page">{{ page }}</span>/<span data-testid="pages">{{ pages }}</span>
